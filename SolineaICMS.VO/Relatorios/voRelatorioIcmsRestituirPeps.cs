...
{
    public class voRelatorioIcmsRestituirPeps : voBase
    {
        ...
        public voRelatorioIcmsRestituirPeps() { }

        public voRelatorioIcmsRestituirPeps(DateTime dataInicioNotaEntrada, DateTime dataFimNotaEntrada, DateTime dataInicioNotaSaida, DateTime dataFimNotaSaida)
        {
