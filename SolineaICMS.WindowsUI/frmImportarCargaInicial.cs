...
{
    public partial class frmImportarCargaInicial : Form
    {
        ...
        /// </summary>
        bllImportarSaldoEstoque bllImportarSaldoEstoque;
        ...
        public frmImportarCargaInicial()
        {
            InitializeComponent();
        }
        ...
        private void frmImportarCargaInicial_Load(object sender, EventArgs e)
        {
        ...
        {
            this.bllImportarSaldoEstoque = new bllImportarSaldoEstoque();
            bllImportarSaldoEstoque.ProcessarSaldoEstoque(FileType, lblNomeArquivo.Text);
        }
        ...
        private void backgroundWorkerImportacao_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (e.Error == null)
            {
                ...
                frmInconsistenciaEstoque frmInconsistenciaEstoque = new frmInconsistenciaEstoque();
                frmInconsistenciaEstoque.MdiParent = this.MdiParent;
                frmInconsistenciaEstoque.Usuario = this.Usuario;
                frmInconsistenciaEstoque.Show();
